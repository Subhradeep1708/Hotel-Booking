...
const RoomList = ({ rooms }: { rooms: any }) => {
    ...
    const [roomType, setRoomType] = useState<"all" | "single" | "double" | "extended">("all");
    ...
    useEffect(() => {
        if (roomType === "all") {
            ...
            const filtered = rooms.data.filter((room: any) => room.type === roomType);
        ...
        <section className="py-16 min-h-[90vh]">
            ...
            <div className="flex flex-col items-center text-center ">
                <div className="relative w-[82px] h-[20px] mb-8">
                    <Image
                        src={"/assets/heading-icon.svg"} alt="heading-logo" fill
                    />
                </div>
            ...
            {/* tabs */}
            <div>
                <Tabs defaultValue="all" className="mx-auto w-[240px] lg:w-[540px] h-[200px] lg:h-auto mb-8">
                    <TabsList className="w-full h-full lg:h-[46px] flex flex-col lg:flex-row">
                        <TabsTrigger value="all" className="w-full h-full "
                    ...
                    return (
                        <div key={room.id} >
                            ...
                            <div className="h-[134px] ">
                                ...
                                <p className="h3 font-secondary font-bold text-accent mb-4"><span>$</span>  {room.price + " "}<span className="text-base font-medium text-secondary">/ night</span></p>
                            </div>
                        </div>
                    )
                })}
