                    ...
                    <div className='flex items-center gap-5 justify-center xl:w-max'>
                        ...
                        <div className='flex gap-2'>
                            {socials.map((item, index) => {
                                return <Link key={index} href={item.link} className='bg-accent text-white hover:bg-accent-hover text-sm w-[28px] h-[28px] flex items-center justify-center transition-all rounded-full' target="_blank" rel="noopener noreferrer">
                                    {item.icon}
                                </Link>
                            })}
                        </div>
